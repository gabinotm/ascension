...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-05-2026 a las 01:56:50
...
INSERT INTO `lectores` (`id`, `dni`, `nombre`, `apellido`, `correo`, `telefono`, `direccion`, `fecha_registro`, `codigo_qr`) VALUES
(1, '12345678', 'Juan', 'Pérez', 'juan@email.com', '999999999', NULL, '2026-05-29 04:06:30', NULL),
(3, '70063703', 'Desarrollo', 'Web', 'da@ds.dsd', 'sdadadsad', NULL, '2026-05-29 05:44:22', NULL),
(4, '70063706', 'Desarrollo', 'Web', 'da@ds.dsd', 'sadada', NULL, '2026-05-29 19:49:13', NULL);
...
(12, '9780132350884s', 'DISEÑOS DE ENCABEZADOSsadads', 'Robert C. Martin', NULL, NULL, NULL, 34, 3, NULL, NULL, 'Disponible', '2026-05-29 19:50:23');
...
INSERT INTO `prestamos` (`id`, `lector_id`, `libro_id`, `fecha_prestamo`, `fecha_devolucion`, `fecha_entrega`, `estado`) VALUES
(2, 4, 12, '2026-05-29 00:00:00', '2026-05-30 00:00:00', '2026-05-29 00:00:00', 'Devuelto'),
(3, 4, 12, '2026-05-29 19:19:00', '2026-05-30 19:20:00', NULL, 'Prestado');
...
--
ALTER TABLE `inventario_detalle`
  ADD CONSTRAINT `inventario_detalle_ibfk_1` FOREIGN KEY (`inventario_id`) REFERENCES `inventario` (`id`),
  ADD CONSTRAINT `inventario_detalle_ibfk_2` FOREIGN KEY (`libro_id`) REFERENCES `libros` (`id`);
